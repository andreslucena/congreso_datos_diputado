Este script parsea una de las webs de 
"congreso.es":http://www.congreso.es/portal/page/portal/Congreso/Congreso/Diputados?_piref73_1333056_73_1333049_1333049.next_page=/wc/menuAbecedarioInicio&tipoBusqueda=completo&idLegislatura=11 y por cada diputado en el Congreso guarda:
...
* La posicion en sector, fila y butaca
...
* Las comiciones en las que participa
...
Basado en el trabajo de @_pablog para la Legislatura X, adaptado para la XI. Se  han unificado estos scripts y se han migrado de "ScraperWiki":https://classic.scraperwiki.com/ a "morph.io":http://morph.io/ 
...
bc. sudo apt-get install libxml2-dev libxslt1-dev python-dev
